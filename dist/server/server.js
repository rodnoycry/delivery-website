...
const cacheDb_1 = require('./functions/cacheDb')(
    0,
    cacheDb_1.cacheItemsDb
)().catch(console.error) // Initial items caching
;(0, cacheDb_1.cacheOrdersDb)().catch(console.error) // Initial orders caching
...
app.use(
    '/images/carousels',
    express_1.default.static('public/images/carousels')
)
...
app.post(
    ...
    utils_1.checkAdmin,
    items_1.handleAddItem
)
app.post(
    '/api/items/edit',
    itemsUpload.single('image'),
    utils_1.checkAdmin,
    items_1.handleEditItem
)
...
app.post(
    ...
    utils_1.checkAdmin,
    promos_1.handleAddPromo
)
app.post(
    '/api/promos/edit',
    promosUpload.single('image'),
    utils_1.checkAdmin,
    promos_1.handleEditPromo
)
...
const carouselsUpload = (0, functions_1.getUploader)(
    './public/images/carousels'
)
app.post(
    '/api/carousels/add',
    carouselsUpload.single('image'),
    utils_1.checkAdmin,
    carousels_1.handleAddCarousel
)
app.post(
    '/api/carousels/edit',
    carouselsUpload.single('image'),
    utils_1.checkAdmin,
    carousels_1.handleEditCarousel
)
app.post(
    '/api/carousels/delete',
    utils_1.checkAdmin,
    carousels_1.handleDeleteCarousel
)
// Orders handling
