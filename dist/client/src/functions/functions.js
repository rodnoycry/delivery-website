...
exports.getCurrentDayRussian = exports.getSumWithDelivery = exports.getSum = exports.getItemsData = void 0;
...
const getSum = (cart, itemsData) => {
    ...
    cart.map(({ id, selected }) => {
        const filteredItemsData = itemsData.filter((itemData) => itemData.id === id);
